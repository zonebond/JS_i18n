...
(function()
{
    ...
    i18n_P.languageSRC = function(lang, dir)
    {
        ...
        var attr = this.script.getAttribute('path');
    ...
    {
        var WhenContentLoaded = function(fn)
        {
            var WIN = window,
                DOC = window.document,
                UND = undefined;
        ...
        }, instance = this, lang = this.detectLanguage(), src = this.languageSRC(lang);

        WhenContentLoaded(function()
        {
            if(!WhenContentLoaded.called) WhenContentLoaded.called = true;
        ...
        this.fetchFile(lang, src, true, function()
        {
            if(!this.canAutoLaunching)
            {
                this.canAutoLaunching = true;
                return;
            }
            instance.i18nTo(lang);
        });
